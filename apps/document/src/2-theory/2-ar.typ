...
==== Optisches Tracking
Optisches Tracking beschreibt ein Verfahren, in welchem Kamerabilder benutzt werden, um die Position der Kamera sowie die Position von Objekten in der Umgebung zu bestimmen. Hierbei kann grundlegend zwischen markerbasiertem und markerlosem Verfahren unterschieden werden @vr-ar-doener. Für diese Arbeit wird aufgrundlage der Relevanz für WebXR-Anwendungen der Fokus auf markerlose Verfahren gelegt.
